<?php
    ...
    $icon_font_size = isset($atts['fancy_icon_fontsize']) ? $atts['fancy_icon_fontsize'] : '35px';
?>
        ...
        <div class="cms-fancybox-item <?php echo (!empty($iconClass)) ? 'has-fancy-icon' : '' ?>">
            ...
            <?php if (!empty($iconClass)) : ?>
                <div class="fancy-box-icon">
                    <i class="<?php echo esc_attr($iconClass);?>" style="<?php echo esc_attr($icon_font_size); ?>"></i>
                </div>
            <?php endif; ?>
