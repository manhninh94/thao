...
foreach ( $images as $attach_id ) {
	...
	if ( 'link_image' === $onclick ) {
		$link_start = '<a class="lightbox" href="' . esc_url($p_img_large[0]) . '">';
		$link_end = '</a>';
	...
	if ('cms_special' === $type) {
		$cms_special_img .= '<img class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="'.(150*$j).'ms" src="'.esc_url($p_img_large[0]).'" alt="image">';
	}
	$j = $j+2;
}
