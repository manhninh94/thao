...
class WW_News_Tabs_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
                'ww_news_tabs', __('CMS News Tab Widget', 'wp_haswell'), array('description' => __('Popular post, recent post and comments.', 'wp_haswell'),)
        );
    }
            ...
            <div class="tabs-3">
                <ul id="tabs" class="nav nav-tabs bootstrap-tabs mb-30 clearfix">
                    <?php if ($show_popular_posts == 'true'): ?>
                        <li class="active"><a href="#tab1" data-toggle="tab"><?php echo __('Popular', 'wp_haswell'); ?></a></li>
                    <?php endif; ?>
                    <?php if ($show_recent_posts == 'true'): ?>
                        <li><a href="#tab2" data-toggle="tab"><?php echo __('Recent', 'wp_haswell'); ?></a></li>
                    <?php endif; ?>
                    <?php if ($show_comments == 'true'): ?>
                        <li><a href="#tab3" data-toggle="tab"><?php echo __('Comments', 'wp_haswell'); ?></a></li>
                    <?php endif; ?>
                </ul>
